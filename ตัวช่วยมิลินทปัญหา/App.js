...
const ShieldIcon = () =>
  React.createElement(
    ...
    React.createElement('path', {
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      d: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.866 10.22 9 11.622 5.134-1.402 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z'
    })
  );
// ⬆️ 1. เปลี่ยนไอคอน ⬆️
...
export default function App() {
  ...
  const systemInstruction = `คุณคือ "ผู้ช่วยมิลิทปัญหา AI" (Military Problem Solver AI)
- ตอบเป็นภาษาไทยล้วน
- ทำหน้าที่เป็นผู้ช่วยให้ข้อมูลเกี่ยวกับยุทธศาสตร์ทางทหาร, ประวัติศาสตร์การรบ, อาวุธยุทโธปกรณ์, และโครงสร้างหน่วยทหาร
- สามารถอธิบายยุทธวิธี หรือหลักการพื้นฐานทางการทหารได้
- **คำเตือนสำคัญ:** ต้องแจ้งผู้ใช้ "ทุกครั้ง" ว่า "ข้อมูลนี้ใช้เพื่อการศึกษาและความรู้ทั่วไปเท่านั้น ไม่ใช่ข้อมูลลับทางราชการ และไม่สามารถใช้ในการปฏิบัติการจริงได้"
- งดให้คำแนะนำที่เกี่ยวข้องกับการปฏิบัติการจริง, ข้อมูลลับ, หรือการเมืองระหว่างประเทศ
`;
  // ⬆️ 2. เปลี่ยนแปลง System Instruction ⬆️
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(ShieldIcon) // ⭐️ เปลี่ยนไอคอน
        ),
        React.createElement(
          'div',
          null,
          React.createElement(
            ...
            'มิลิทปัญหา AI' // ⭐️ เปลี่ยนข้อความ
          ),
          React.createElement(
            'p',
            { className: 'text-sm text-gray-500' },
            'ผู้ช่วยข้อมูลยุทธศาสตร์และประวัติศาสตร์การรบ' // ⭐️ เปลี่ยนข้อความ
          )
        )
      )
    ),
        ...
        messages.length === 0 &&
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'สวัสดีครับ, มีข้อสงสัยทางการทหารหรือไม่?'
            ),
            React.createElement(
              'p',
              { className: 'text-gray-500' },
              'สอบถามข้อมูลยุทธศาสตร์, ยุทธวิธี, หรือประวัติศาสตร์การรบ' // ⭐️ เปลี่ยนข้อความ
            ),
            React.createElement(
              'p',
              { className: 'text-xs text-gray-400 mt-4' },
              'ตัวอย่าง: "ยุทธการคีมโลหะคืออะไร?" หรือ "รถถัง T-34 มีจุดเด่นอย่างไร?"' // ⭐️ เปลี่ยนข้อความ
            ),
             React.createElement(
              'div',
              { className: 'mt-6 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-3 rounded-md text-sm' },
              React.createElement('strong', null, 'คำเตือน:'),
              ' ข้อมูลนี้ใช้เพื่อการศึกษาและความรู้ทั่วไปเท่านั้น ไม่สามารถใช้ในการปฏิบัติการจริงได้'
            )
          ),
        // ⬆️ 4. เปลี่ยนแปลง Welcome Message ⬆️
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', {
            ...
            placeholder: 'พิมพ์คำถามด้านการทหารที่นี่...',
            // ⬆️ 5. เปลี่ยน Placeholder ⬆️
