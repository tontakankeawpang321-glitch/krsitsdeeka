...
const AcademicCapIcon = () =>
  React.createElement(
    ...
    React.createElement('path', {
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      d: 'M12 6.253v13.5M21 12l-9 5-9-5 9-5 9 5z'
    }),
     React.createElement('path', {
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      d: 'M3 10.5v5.25a2.25 2.25 0 002.25 2.25h13.5a2.25 2.25 0 002.25-2.25V10.5'
    })
  );
// ⬆️ 1. เปลี่ยนไอคอน ⬆️
...
export default function App() {
  ...
  const systemInstruction = `คุณคือ "ติวเตอร์นาฏศิลป์ AI"
- ตอบเป็นภาษาไทยล้วน
- ทำหน้าที่เป็นติวเตอร์ ช่วยผู้ใช้เตรียมสอบวิชานาฏศิลป์ไทย
- สามารถสรุปเนื้อหาสำคัญ, อธิบายประวัติ, องค์ประกอบการแสดง, ท่ารำ, การแต่งกาย และดนตรี
- สามารถตั้งคำถามเพื่อทดสอบความเข้าใจ และอธิบายคำตอบที่ถูกต้อง
- ให้ข้อมูลที่แม่นยำ กระชับ และเข้าใจง่าย
`;
  // ⬆️ 2. เปลี่ยนแปลง System Instruction ⬆️
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(AcademicCapIcon) // ⭐️ เปลี่ยนไอคอน
        ),
        React.createElement(
          'div',
          null,
          React.createElement(
            ...
            'ติวสอบนาฏศิลป์ AI' // ⭐️ เปลี่ยนข้อความ
          ),
          React.createElement(
            'p',
            { className: 'text-sm text-gray-500' },
            'ผู้ช่วยสรุปเนื้อหาและเก็งข้อสอบนาฏศิลป์' // ⭐️ เปลี่ยนข้อความ
          )
        )
      )
    ),
        ...
        messages.length === 0 &&
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'สวัสดีครับ, พร้อมติวสอบหรือยัง?'
            ),
            React.createElement(
              'p',
              { className: 'text-gray-500' },
              'ถามเนื้อหาที่สงสัย หรือให้ช่วยสรุปเรื่องที่ต้องสอบได้เลย' // ⭐️ เปลี่ยนข้อความ
            ),
            React.createElement(
              'p',
              { className: 'text-xs text-gray-400 mt-4' },
              'ตัวอย่าง: "สรุปประวัติโขน" หรือ "ลองถามคำถามเกี่ยวกับละครใน"' // ⭐️ เปลี่ยนข้อความ
            )
          ),
        // ⬆️ 4. เปลี่ยนแปลง Welcome Message ⬆️
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', {
            ...
            placeholder: 'พิมพ์คำถาม หรือเรื่องที่อยากให้สรุป...',
            // ⬆️ 5. เปลี่ยน Placeholder ⬆️
