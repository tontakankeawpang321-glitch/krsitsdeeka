...
export default function App() {
  ...
  const systemInstruction = `คุณคือ "ผู้ช่วยแปลรูปอาหาร AI"
- ตอบเป็นภาษาไทยล้วน
- ทำหน้าที่วิเคราะห์ "คำอธิบาย" หรือ "ชื่อ" ของอาหารที่ผู้ใช้ป้อนเข้ามา
- "จินตนาการว่าผู้ใช้อัปโหลดรูปมา" และคุณกำลังอธิบายรูปนั้น
- ตอบกลับโดยระบุ: ชื่ออาหาร, วัตถุดิบหลัก, รสชาติ (เช่น เปรี้ยว เค็ม หวาน), และข้อมูลน่าสนใจ
- ตัวอย่าง: หากผู้ใช้ป้อน "ก๋วยเตี๋ยวเส้นเล็กน้ำใสมีลูกชิ้น", ให้ตอบประมาณว่า "นี่คือ ก๋วยเตี๋ยวน้ำใส ครับ/ค่ะ ใช้วัตถุดิบหลักคือเส้นเล็ก ลูกชิ้น และน้ำซุปใส รสชาติกลมกล่อม..."
- หากผู้ใช้ถามชื่ออาหารที่ไม่รู้จัก ให้อธิบายทันที
`;
  // ⬆️ 2. เปลี่ยนแปลง System Instruction ⬆️
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(CameraIcon) // ⭐️ เปลี่ยนไอคอน
        ),
        React.createElement(
          'div',
          null,
          React.createElement(
            ...
            'แปลรูปอาหาร AI' // ⭐️ เปลี่ยนข้อความ
          ),
          React.createElement(
            'p',
            { className: 'text-sm text-gray-500' },
            'อธิบายชื่อ, วัตถุดิบ, และรสชาติ' // ⭐️ เปลี่ยนข้อความ
          )
        )
      )
    ),
        ...
        messages.length === 0 &&
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'สวัสดีครับ, สงสัยเมนูไหนครับ?'
            ),
            React.createElement(
              'p',
              { className: 'text-gray-500' },
              'เพียงพิมพ์ชื่ออาหาร หรืออธิบายลักษณะมา' // ⭐️ เปลี่ยนข้อความ
            ),
            React.createElement(
              'p',
              { className: 'text-xs text-gray-400 mt-4' },
              'ตัวอย่าง: "ก๋วยเตี๋ยวเส้นเล็กน้ำใสมีลูกชิ้น" หรือ "ผัดไทยคืออะไร?"' // ⭐️ เปลี่ยนข้อความ
            )
          ),
        // ⬆️ 4. เปลี่ยนแปลง Welcome Message ⬆️
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', {
            ...
            placeholder: 'พิมพ์ชื่ออาหาร หรืออธิบายลักษณะ...',
            // ⬆️ 5. เปลี่ยน Placeholder ⬆️
