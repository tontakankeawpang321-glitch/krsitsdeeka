...
export default function App() {
  ...
  const systemInstruction = `คุณคือ "ผู้ช่วยยารักษาโรค AI"
- ตอบเป็นภาษาไทยล้วน
- ทำหน้าที่เป็นผู้ช่วยให้ข้อมูลเกี่ยวกับยา การใช้ยา ผลข้างเคียง และข้อควรระวัง
- สามารถอธิบายกลไกการออกฤทธิ์ของยา
- **คำเตือนสำคัญ:** ต้องแจ้งผู้ใช้ "ทุกครั้ง" ว่า "ข้อมูลนี้ใช้เพื่อการศึกษาเท่านั้น ไม่สามารถทดแทนคำแนะนำของแพทย์หรือเภสัชกรได้ กรุณาปรึกษาผู้เชี่ยวชาญด้านสุขภาพก่อนใช้ยาทุกครั้ง"
- งดการวินิจฉัยโรค หรือแนะนำยาสำหรับอาการโดยไม่ระบุว่าเป็นเพียงข้อมูลทั่วไป
`;
  // ⬆️ 2. เปลี่ยนแปลง System Instruction ⬆️
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(HeartIcon) // ⭐️ เปลี่ยนไอคอน
        ),
        React.createElement(
          'div',
          null,
          React.createElement(
            ...
            'ยารักษาโรค AI' // ⭐️ เปลี่ยนข้อความ
          ),
          React.createElement(
            'p',
            { className: 'text-sm text-gray-500' },
            'ค้นหาข้อมูลยา การใช้ และผลข้างเคียง (เพื่อการศึกษาเท่านั้น)' // ⭐️ เปลี่ยนข้อความ
          )
        )
      )
    ),
        ...
        messages.length === 0 &&
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'สวัสดีครับ, สอบถามเรื่องยาได้เลย'
            ),
            React.createElement(
              'p',
              { className: 'text-gray-500' },
              'ค้นหาข้อมูลยา การใช้งาน ผลข้างเคียง หรือข้อควรระวัง' // ⭐️ เปลี่ยนข้อความ
            ),
            React.createElement(
              'p',
              { className: 'text-xs text-gray-400 mt-4' },
              'ตัวอย่าง: "ยาพาราเซตามอล ใช้ยังไง?" หรือ "ยาแก้แพ้มีผลข้างเคียงอะไรบ้าง?"' // ⭐️ เปลี่ยนข้อความ
            ),
             React.createElement(
              'div',
              ...
              ' ข้อมูลนี้ใช้เพื่อการศึกษาเท่านั้น ไม่สามารถทดแทนคำแนะนำของแพทย์หรือเภสัชกรได้'
            )
          ),
        // ⬆️ 4. เปลี่ยนแปลง Welcome Message ⬆️
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', {
            ...
            placeholder: 'พิมพ์ชื่อยาที่ต้องการค้นหาที่นี่...',
            // ⬆️ 5. เปลี่ยน Placeholder ⬆️
            'aria-label': 'Chat input',
            disabled: isLoading,
            className:
              'flex-1 w-full px-4 py-2 border border-gray-300 rounded-full focus:outlibne-none focus:ring-2 focus:ring-blue-500 disabled:bg-gray-100'
          }),
          React.createElement(
            'button',
            {
