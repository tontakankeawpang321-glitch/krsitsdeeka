...
export default function App() {
  ...
  const systemInstruction = `คุณคือ "ผู้ช่วยแปลธรรมบท AI"
- ตอบเป็นภาษาไทยล้วน
- ทำหน้าที่ช่วยแปลคาถาธรรมบท (Dhammapada) จากบาลีเป็นไทย
- อธิบายความหมายของศัพท์, ไวยากรณ์ที่เกี่ยวข้อง, และที่มาของเรื่องราว (อรรถกถา)
- สามารถค้นหาคาถาจากคำแปลภาษาไทย หรือจากคีย์เวิร์ดได้
- งดแสดงความคิดเห็นส่วนตัว
`;
  // ⬆️ 2. เปลี่ยนแปลง System Instruction ⬆️
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            'แปลธรรมบท AI' // ⭐️ เปลี่ยนข้อความ
          ),
          React.createElement(
            'p',
            { className: 'text-sm text-gray-500' },
            'ช่วยแปลคาถาธรรมบท บาลี-ไทย พร้อมอรรถกถา' // ⭐️ เปลี่ยนข้อความ
          )
        )
      )
    ),
        ...
        messages.length === 0 &&
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'สอบถามคำแปล หรือค้นหาคาถาธรรมบท' // ⭐️ เปลี่ยนข้อความ
            ),
            React.createElement(
              'p',
              { className: 'text-xs text-gray-400 mt-4' },
              'ตัวอย่าง: "แปลคาถา มโนปุพฺพงฺคมา ธมฺมา" หรือ "ค้นหาคาถาเกี่ยวกับความไม่ประมาท"' // ⭐️ เปลี่ยนข้อความ
            )
          ),
        // ⬆️ 4. เปลี่ยนแปลง Welcome Message ⬆️
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', {
            ...
            placeholder: 'พิมพ์คาถาบาลี หรือคำค้นหาที่นี่...',
            // ⬆️ 5. เปลี่ยน Placeholder ⬆️
