...
export default function App() {
  ...
  const systemInstruction = `คุณคือ "ผู้ช่วยครูทหารใหม่ AI"
- ตอบเป็นภาษาไทยล้วน
- ทำหน้าที่เป็นผู้ช่วยครูฝึกทหารใหม่
- ให้ข้อมูลเกี่ยวกับระเบียบวินัย, ท่าฝึก, แผนการสอน, และจิตวิทยาการปกครอง
- สามารถช่วยร่างตารางการฝึก หรือสรุปคู่มือ
- ให้ข้อมูลเพื่อการศึกษาและการฝึกเท่านั้น
`;
  // ⬆️ 2. เปลี่ยนแปลง System Instruction ⬆️
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(ClipboardCheckIcon) // ⭐️ เปลี่ยนไอคอน
        ),
        React.createElement(
          'div',
          null,
          React.createElement(
            ...
            'ครูทหารใหม่ AI' // ⭐️ เปลี่ยนข้อความ
          ),
          React.createElement(
            'p',
            { className: 'text-sm text-gray-500' },
            'ผู้ช่วยวางแผนการสอนและข้อมูลระเบียบ' // ⭐️ เปลี่ยนข้อความ
          )
        )
      )
    ),
        ...
        messages.length === 0 &&
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'สวัสดีครับ, พร้อมสำหรับการฝึกหรือยังครับ?'
            ),
            React.createElement(
              'p',
              { className: 'text-gray-500' },
              'สอบถามแผนการสอน, ระเบียบวินัย, หรือเทคนิคการปกครองได้เลย' // ⭐️ เปลี่ยนข้อความ
            ),
            React.createElement(
              'p',
              { className: 'text-xs text-gray-400 mt-4' },
              'ตัวอย่าง: "สรุปท่าฝึกบุคคลเบื้องต้น" หรือ "หลักการปกครองทหารใหม่"' // ⭐️ เปลี่ยนข้อความ
            )
          ),
        // ⬆️ 4. เปลี่ยนแปลง Welcome Message ⬆️
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', {
            type: 'text',
            value: input,
            onChange: e => setInput(e.taget.value),
            // ⬇️ 5. เปลี่ยน Placeholder ⬇️
            placeholder: 'พิมพ์คำถามสำหรับครูฝึกที่นี่...',
            // ⬆️ 5. เปลี่ยน Placeholder ⬆️
