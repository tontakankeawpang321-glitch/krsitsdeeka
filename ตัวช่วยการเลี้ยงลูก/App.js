...
const UsersIcon = () =>
  React.createElement(
    ...
    React.createElement('path', {
      strokeLinecap: 'round',
      strokeLinejoin: 'round',
      d: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 016-6h6m6 0a6 6 0 016 6v1h-3m-6-3a4 4 0 100-5.292 4 4 0 000 5.292z'
    })
  );
// ⬆️ 1. เปลี่ยนไอคอน ⬆️
...
export default function App() {
  ...
  const systemInstruction = `คุณคือ "ผู้ช่วยการเลี้ยงลูก AI"
- ตอบเป็นภาษาไทยล้วน
- ทำหน้าที่เป็นผู้ช่วยให้คำแนะนำเรื่องการเลี้ยงลูก
- ให้ข้อมูลเกี่ยวกับพัฒนาการเด็กในแต่ละช่วงวัย, โภชนาการ, การจัดการพฤติกรรม, และกิจกรรมเสริมพัฒนาการ
- **คำเตือนสำคัญ:** ต้องแจ้งผู้ใช้เสมอว่า "ข้อมูลนี้เป็นคำแนะนำทั่วไป หากมีข้อกังวลเรื่องสุขภาพหรือพัฒนาการร้ายแรง ควรปรึกษาแพทย์หรือผู้เชี่ยวชาญ"
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(UsersIcon) // ⭐️ เปลี่ยนไอคอน
        ),
        React.createElement(
          'div',
          null,
          React.createElement(
            ...
            'การเลี้ยงลูก AI' // ⭐️ เปลี่ยนข้อความ
          ),
          React.createElement(
            'p',
            { className: 'text-sm text-gray-500' },
            'ผู้ช่วยให้คำแนะนำการเลี้ยงลูก' // ⭐️ เปลี่ยนข้อความ
          )
        )
      )
    ),
        ...
        messages.length === 0 &&
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'สวัสดีครับ, มีคำถามเรื่องการเลี้ยงลูกไหมครับ?'
            ),
            React.createElement(
              'p',
              { className: 'text-gray-500' },
              'สอบถามเรื่องพัฒนาการเด็ก, โภชนาการ, หรือพฤติกรรม' // ⭐️ เปลี่ยนข้อความ
            ),
            React.createElement(
              'p',
              { className: 'text-xs text-gray-400 mt-4' },
              'ตัวอย่าง: "ลูก 2 ขวบไม่ยอมกินข้าว" หรือ "วิธีเสริมพัฒนาการเด็ก 1 ขวบ"' // ⭐️ เปลี่ยนข้อความ
            ),
             React.createElement(
              'div',
              { className: 'mt-6 bg-yellow-100 border-l-4 border-yellow-500 text-yellow-700 p-3 rounded-md text-sm' },
              React.createElement('strong', null, 'คำแนะนำ:'),
              ' ข้อมูลนี้เป็นคำแนะนำทั่วไป หากมีข้อกังวลเรื่องสุขภาพ ควรปรึกษาแพทย์'
            )
          ),
        // ⬆️ 4. เปลี่ยนแปลง Welcome Message ⬆️
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', {
            ...
            placeholder: 'พิมพ์คำถามเกี่ยวกับการเลี้ยงลูกที่นี่...',
            // ⬆️ 5. เปลี่ยน Placeholder ⬆️
