...
export default function App() {
  ...
  const systemInstruction = `คุณคือ "ผู้ช่วยเทคนิคการพูด AI"
- ตอบเป็นภาษาไทยล้วน
- ทำหน้าที่เป็นโค้ชส่วนตัวด้านการพูดในที่สาธารณะ
- ให้คำแนะนำเชิงลึกเกี่ยวกับ เทคนิคการใช้เสียง (Vocal variety), ภาษากาย (Body Language), การสบตา (Eye Contact) และการจัดการความตื่นเต้น
- สามารถวิเคราะห์บทพูดที่ผู้ใช้ส่งมา และให้คำแนะนำเพื่อปรับปรุงโครงสร้าง, คำนำ, เนื้อหา, และบทสรุป
- ให้กำลังใจและสร้างความมั่นใจให้กับผู้ใช้
`;
  // ⬆️ 2. เปลี่ยนแปลง System Instruction ⬆️
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(MicrophoneIcon) // ⭐️ เปลี่ยนไอคอน
        ),
        React.createElement(
          'div',
          null,
          React.createElement(
            ...
            'ตัวช่วยเทคนิคการพูด AI' // ⭐️ เปลี่ยนข้อความ
          ),
          React.createElement(
            'p',
            { className: 'text-sm text-gray-500' },
            'โค้ชส่วนตัวด้านการพูดในที่สาธารณะ' // ⭐️ เปลี่ยนข้อความ
          )
        )
      )
    ),
        ...
        messages.length === 0 &&
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'พร้อมที่จะพัฒนาการพูดของคุณหรือยัง?'
            ),
            React.createElement(
              'p',
              { className: 'text-gray-500' },
              'ส่งบทพูดของคุณมาให้วิเคราะห์ หรือสอบถามเทคนิคได้เลย' // ⭐️ เปลี่ยนข้อความ
            ),
            React.createElement(
              'p',
              { className: 'text-xs text-gray-400 mt-4' },
              'ตัวอย่าง: "ทำยังไงให้พูดไม่ตื่นเต้น?" หรือ "ช่วยเกลาคำนำบทพูดนี้หน่อย..."' // ⭐️ เปลี่ยนข้อความ
            )
          ),
        // ⬆️ 4. เปลี่ยนแปลง Welcome Message ⬆️
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', {
            ...
            placeholder: 'พิมพ์คำถาม หรือส่งบทพูดให้วิเคราะห์...',
            // ⬆️ 5. เปลี่ยน Placeholder ⬆️
