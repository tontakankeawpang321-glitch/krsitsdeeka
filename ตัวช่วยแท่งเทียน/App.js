...
export default function App() {
  ...
  const systemInstruction = `คุณคือ "ผู้ช่วยแท่งเทียนและเทรด AI"
- ตอบเป็นภาษาไทยล้วน
- ทำหน้าที่เป็นผู้ช่วยวิเคราะห์กราฟแท่งเทียน (Candlestick Patterns) และเทคนิคการเทรด
- อธิบายรูปแบบแท่งเทียนต่างๆ เช่น Doji, Hammer, Engulfing
- อธิบาย Indicators พื้นฐาน เช่น Moving Average, RSI, MACD
- ให้ข้อมูลเกี่ยวกับแนวรับ-แนวต้าน และการตีความเทรนด์
- เน้นย้ำว่านี่คือข้อมูลเพื่อการศึกษา ไม่ใช่คำแนะนำการลงทุน (Disclaimer)
`;
  // ⬆️ 2. เปลี่ยนแปลง System Instruction ⬆️
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(TrendingUpIcon) // ⭐️ เปลี่ยนไอคอน
        ),
        React.createElement(
          'div',
          null,
          React.createElement(
            ...
            'แท่งเทียนและเทรด AI' // ⭐️ เปลี่ยนข้อความ
          ),
          React.createElement(
            'p',
            { className: 'text-sm text-gray-500' },
            'ผู้ช่วยวิเคราะห์รูปแบบแท่งเทียนและเทคนิคเทรด' // ⭐️ เปลี่ยนข้อความ
          )
        )
      )
    ),
        ...
        messages.length === 0 &&
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              'สวัสดีครับ, พร้อมเรียนรู้หรือยัง?'
            ),
            React.createElement(
              'p',
              { className: 'text-gray-500' },
              'สอบถามเกี่ยวกับรูปแบบแท่งเทียน หรือ Indicators ที่คุณสนใจได้เลย' // ⭐️ เปลี่ยนข้อความ
            ),
            React.createElement(
              'p',
              { className: 'text-xs text-gray-400 mt-4' },
              'ตัวอย่าง: "แท่งเทียน Hammer คืออะไร?" หรือ "RSI ใช้ดูอะไร?"' // ⭐️ เปลี่ยนข้อความ
            )
          ),
        // ⬆️ 4. เปลี่ยนแปลง Welcome Message ⬆️
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement('input', {
            ...
            placeholder: 'พิมพ์คำถามเกี่ยวกับแท่งเทียนหรือ Indicator...',
            // ⬆️ 5. เปลี่ยน Placeholder ⬆️
